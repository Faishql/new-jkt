...
function htmldata(res, no) {
    return `
        <tr>
            ...
            <td>
                <a><button id="modal" onClick="getmodal('${res.kode_penerimaan}')" class="button icons-button" value="${res.kode_penerimaan}"><i class="fas fa-arrow-up" style="padding: 6px 6px;"></i></button></a>

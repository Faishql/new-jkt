...
function elemen(data, no) {
    return `<tr>
                ...
                <td>
                    <a><button id="modal" onClick="getmodal('${
                        data.kode_penerimaan
                    }')"
                            class="icons-button" value="${
                                data.kode_penerimaan
                            }"><img src="${url_origin}/assets/upload.svg"></button></a>
                    <a><button class="icons-button" onClick="getmodal4('${
                        data.kode_penerimaan
                    }')"><img src="${url_origin}/assets/eye.svg"></button></a>
                </td>
            </tr>`;
}
